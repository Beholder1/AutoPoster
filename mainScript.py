...
class MainScript:
    def __init__(self, hide, title, email1):
        ...
        menu = driver.find_elements_by_css_selector(
            ".cwj9ozl2.qbxu24ho.bxzzcbxg.lxuwth05.h2mp5456.beltcj47.p86d2i9g.aot14ch1.kzx2olss.goun2846.ccm00jje.s44p3ltw.mk2mc5f4.frvqaej8.ed0hlay0.afxsp9o4.jcgfde61.j83agx80.cbu4d94t.ni8dbmo4.stjgntxs.l9j0dhe7.du4w35lb.hw4tbnyy.nhd2j8a9.lzcic4wl")

        # Kategoria WIP
        menu[0].click()
        time.sleep(1)
        tools = driver.find_elements_by_css_selector(
