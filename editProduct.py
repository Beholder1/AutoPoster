...
class EditProduct:
    def __init__(self, product, db):
        ...
        def addCategory():
            ...
            label1 = tk.Label(frame1, text="Kategoria " + str(self.counter) + ":", background="white", foreground="black", font=('Verdana', 12))
        ...
        def executeAdding(button2, entry6, label2):
            ...
            button3.configure(
                command=lambda c=entry6.get(), b=button2, e=entry6, b1=button3, l=label2: executeDelete(db.getC(c), b, e, b1, l))
        ...
        ttk.Label(frame1, text="Nazwa: ", background="white", foreground="black", font=('Verdana', 12)).grid(row=0, column=0)
        ttk.Label(frame1, text=wholeProduct[1], background="white", foreground="black", font=('Verdana', 12)).grid(row=0, column=1)
        entry1 = ttk.Entry(frame1)
        entry1.grid(row=0, column=2)
        button = tk.Button(frame1, text="Edytuj", command=lambda: updateProduct())
        button.grid(row=0, column=3)

        ttk.Label(frame1, text="Tytuł: ", background="white", foreground="black", font=('Verdana', 12)).grid(row=1, column=0)
        ttk.Label(frame1, text=wholeProduct[2][0: 15] + "...", background="white", foreground="black", font=('Verdana', 12)).grid(row=1, column=1)
        ...
        ttk.Label(frame1, text="Cena: ", background="white", foreground="black", font=('Verdana', 12)).grid(row=2, column=0)
        ttk.Label(frame1, text=wholeProduct[3], background="white", foreground="black", font=('Verdana', 12)).grid(row=2, column=1)
        ...
        ttk.Label(frame1, text="Opis: ", background="white", foreground="black", font=('Verdana', 12)).grid(row=3, column=0)
        ttk.Label(frame1, text=wholeProduct[4][0: 15] + "...", background="white", foreground="black", font=('Verdana', 12)).grid(row=3, column=1)
        ...
        for category in categories:
            label = ttk.Label(frame1, text="Kategoria " + str(self.counter) + ":", background="white", foreground="black", font=('Verdana', 12))
            ...
            if self.counter != 1:
                ...
                button1.configure(command=lambda c=category[0], b=button, e=entry4, b1=button1, l=label: executeDelete(c, b, e, b1, l))
